...
public class LivroRepository {
    ...
    public void insertLivro(Livro l){
        listaLivrosRef.push().setValue(l).addOnCompleteListener(task -> {
            if (task.isSuccessful())
                Log.d("MYMED2023", "Livro inserido: " + l.getNome());
            else
                Log.d("MYMED2023", "Não foi possível inserir o livro: " + l.getNome());
        });
    }
