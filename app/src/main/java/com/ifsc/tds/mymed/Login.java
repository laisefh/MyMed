...
public class Login extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        Button login = view.findViewById(R.id.botaoLogar);
        login.setOnClickListener(view1 -> fazerLogin());
        Button cadastrarButton = view.findViewById(R.id.botaoCadastrar);
        cadastrarButton.setOnClickListener(view1 -> fazerCadastro());
        return view;
    }
    ...
    void goToHome(){
        NavController nav = Navigation.findNavController(getView());
        nav.navigate(R.id.action_login_to_hometest);
    }
